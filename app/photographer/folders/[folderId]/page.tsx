  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">{folder.totalFiles || 0} foto · Status: {folder.status === "ready" ? "✅ Siap" : "⏳ Uploading"}</p>
          </div>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-4 text-sm text-blue-700">
        📌 Upload foto langsung ke folder di bawah ini. Setelah selesai, klik <b>"Tandai Selesai Upload"</b>.
      </div>
